  ...
  >
    ...
    >
      <div
        ...
        :key="index"
        class="flex flex-shrink-0 w-84 flex-col transition-all duration-700 relative pt-1"
      >
        <transition
        ...
        >
          ...
          >
            <p class="p-0.5 pb-0 mt-5">🔔 GOTOWE</p>
          </div>
        </transition>
        <div
        ...
        >
          <h3
            class="font-semibold text-left text-2base text-gray-700 tracking-wide p-2 pb-0 flex-1 transition-all duration-700"
            :class="{
              'opacity-100': dateStor.ready != tab.id,
        ...
        >
          ...
          >
            ...
            >
              <div
                class="w-1.2 opacity-80 transition-all duration-500"
                :class="{
